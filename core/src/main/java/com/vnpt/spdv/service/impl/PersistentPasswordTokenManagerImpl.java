...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.vnpt.spdv.service.impl.PasswordTokenManager#generateRecoveryToken(com.vnpt.spdv.model.User)
     */
    @Override
    ...
    /**
     * @see com.vnpt.spdv.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.vnpt.spdv.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.vnpt.spdv.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
